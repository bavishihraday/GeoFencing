...
import 'package:fairticketsolutions_demo_app/screens/enrollment_success_screen.dart';

class HealthReqConfirmedScreen extends StatelessWidget {
  const HealthReqConfirmedScreen({Key? key}) : super(key: key);
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          text: const TextSpan(
                              ...
                              children: [
                                TextSpan(text: "Health Requirement\n"),
                                TextSpan(
                                  text: "Confirmed\n\n",
                                  style: TextStyle(
                                      fontWeight: FontWeight.w800,
                                ...
                                TextSpan(text: "1959-Dec-02", style: TextStyle(fontSize: 20.0))
                              ]
                          ),
                        )
                      )
