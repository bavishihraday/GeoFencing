...
class VoiceEnrollConfirmScreen extends StatelessWidget {
  const VoiceEnrollConfirmScreen({Key? key}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: RichText(
                          ...
                          text: const TextSpan(
                              ...
                              children: [
                                TextSpan(text: "Alan Mark Gelfand\n", style: TextStyle(fontSize: 30)),
                                TextSpan(text: "You have successfully enrolled your voice.\n\n"),
                                TextSpan(text: "Your Voice can now be used as your primary way of checking in when you receive the check-in notification at any event you attend.\n")
                              ]
                          ),
                        )
                      )
